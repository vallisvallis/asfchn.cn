...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的“美利达”遥控飞机追逐赛 打分表</h4></div>
    <form action="" >
    ...
    圈数：<input type="text" name="score1one" style="width:75px" value="${ mangoptionsmatch.score1one}">圈<br>
    时间：<input type="text" name="score2one" style="width:75px" value="${ mangoptionsmatch.score2one}">秒
    ...
    <td>第二轮成绩</td>
     <td>
   	...
   	圈数：<input type="text" name="score1two" style="width:75px" value="${ mangoptionsmatch.score1two}">圈<br>
   	 时间：<input type="text" name="score2two" style="width:75px" value="${ mangoptionsmatch.score2two}">秒
