...
function getRefreePasswordtoChange(){
var form =document.forms[0];


form.action="<%=basePath %>getRefreePasswordtoChange";
form.method="post";
form.submit();
...
<link rel="stylesheet" type="text/css"
 ...
 <!--   <tr>
   ...
   <div class="form-group" align="center">
		<div >
			<button type="submit" class="btn btn-default" onclick="getRefreePasswordtoChange()" align="center">确定修改</button>
		</div>
	</div>
   </form></div>
