...
<link rel="stylesheet" type="text/css"
	...
	<tr>
	<td>会员名称：</td>
	<td><input type="text" name="name" placeholder="请输入名称">(必填)</td>
	</tr>
	...
	<tr>
	<td>年龄：</td>
	<td><input type="text" name="age">(必填)</td>
	</tr>
	<tr>
	<td>注册地：</td>
	...
	<tr>
	<td>身份证号:</td>
	<td><input type="text" name="certnumber" id="checkCert" onchange="go()">(必填)</td>
	</tr>
	<tr>
	<td>个人信息简介:</td>
