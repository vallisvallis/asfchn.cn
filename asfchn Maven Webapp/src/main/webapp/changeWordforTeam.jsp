...
function getPasswordtoChange(){
var form =document.forms[0];


form.action="<%=basePath %>getPasswordtoChange";
form.method="post";
form.submit();
...
<link rel="stylesheet" type="text/css"
  ...
  <body>
   <div align="center">
   <div>修改${hxTeam.fullname }的密码</div>
 ...
 <!--   <tr>
   ...
   <div class="form-group" align="center">
		<div >
			<button type="submit" class="btn btn-default" onclick="getPasswordtoChange()" align="center">确定修改</button>
		</div>
	</div>
   </form></div>
