...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的“蓝翔”初级橡筋动力飞机竞时赛 打分表${rid}</h4></div>
    <form action="" >
...
<input type="text" name="scoreone" style="width:75px">秒
   ...
   <input type="text" name="scoretwo" style="width:75px">秒
  ...
  <!--    <tr>
   ...
   <!--<td><input type="text" name="score3"></td>-->
    ...
    <c:choose>
    <c:when test="${!(thisPeopleScore.score2 eq '0.0')&&!(thisPeopleScore.score2 eq null)}"> <a href="readAndMarking?refereeid=${rid}">扫码打分</a></c:when>
    <c:when test="${(thisPeopleScore.score2 eq null)|| thisPeopleScore.score2 eq '0.0'}"> <button type="submit" onclick="getMarking1()">确定打分</button></c:when>
    </c:choose>
