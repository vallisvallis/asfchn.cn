...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的火箭遥控推进滑翔机（S8C） 打分表</h4></div>
    <form action="" >
    ...
    <c:choose>
    <c:when test="${turnmatchlist.isconfirm eq '2'}">
   ...
   着陆得分  <input type="text" name="oneturnpointmeter"  style="width:75px">米<br>
  留空得分 <input type="text" name="min1"  style="width:75px">分 <input type="text" name="second1"  style="width:75px">秒
 ...
 着陆得分 <input type="text" name="twoturnpointmeter" style="width:75px">米<br>
     留空得分 <input type="text" name="min2" style="width:75px">分 <input type="text" name="second2"  style="width:75px">秒
