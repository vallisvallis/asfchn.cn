    ...
    <div id="wrapper">
                ...
                <ul class="nav nav_L" id="side-menu">
                    <li class="nav-header">
                        <div class="profile-element">
                            ...
                            <div class="logo-element">${referee.name}</div>
                        </div>
                    ...
                    <li>
                        <a class="J_menuItem" href="showMatchInReferee?rid=${referee.id }">
                            <i class="fa fa-sitemap"></i>
                            <span class="nav-label">查看所有参赛人员</span>
                    ...
                    <li>
                        <a href="">
                            ...
                            <span class="nav-label">查看分数</span>
                        </a>
                        <ul class="nav nav-second-level">
                        <li>
                       <!--   <a class="J_menuItem" href="readAndMarking?refereeid=${referee.id}">裁判系统直接扫码打分</a>-->
                        </li>   
                         <li>
                        <a class="J_menuItem" href="showScore">查看排名分数</a>
                        <!--  <a class="J_menuItem" href="showScoreselectTeam">查看团体排名</a>-->
                        </li>                        
                        </ul>
                    </li>
                    <!--<li>
                  ...
                  <!-- <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="tochangewordforReferee?id=${referee.id }">修改密码</a></li>                            
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0 ;height:18px; padding:0 ;">
                    ...
                    <ul class="nav nav_r navbar-top-links navbar-right">  
                        <li>
                        <a class="J_menuItem" href="readAndMarking?refereeid=${referee.id}">扫码</a>
                        </li> 
                        <li>
                        <a href="bornAllJpscoreList?matchid=21">born!</a>
                        </li>
<li>
<input type=button value=刷新 onclick="location.reload()">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="showMatchInReferee?rid=${referee.id }" frameborder="0" data-id="" seamless> </iframe>
            </div>
         <!--    <div class="footer">
