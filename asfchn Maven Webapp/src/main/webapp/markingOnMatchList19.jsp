...
<html>
  ...
  <body>
  <div align="center">
  <div><h1>${thisJoinMatchTeamPeople.name }的遥控纸飞机穿龙门赛 打分表</h1></div>
    <form action="" >
    ...
    <td>第一轮成绩</td>
      <td>
    <input type="text" name="scoreone"  style="width:75px" value="${twoptionsmatch.scoreone}">
    </td>
    </tr>
    <tr>
    <td>第二轮成绩</td>
...
<input type="text" name="scoretwo"  style="width:75px" value="${twoptionsmatch.scoreone}">
