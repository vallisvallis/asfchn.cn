...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的${thisJoinMatchTeamPeople.joinmatchlistinname }打分表${rid}</h4></div>
    <form action="" >
    ...
    <input type="hidden"  value="${twoptionsmatch.oneroundisconfirm}" name="oneroundisconfirm" >
    <input type="hidden"  value="${twoptionsmatch.tworoundisconfirm}" name="tworoundisconfirm" >
...
<input type="text" name="scoreone" style="width:75px" value="${twoptionsmatch.scoreone}" disabled="disabled">秒
    </td>
    </tr>
   ...
   <input type="text" name="scoretwo" style="width:75px" value="${twoptionsmatch.scoretwo}"  disabled="disabled">秒
  ...
  <!--    <tr>
   ...
   <!--<td><input type="text" name="score3"></td>-->
     ...
     <!--<a href="readAndMarking?refereeid=${rid}">扫码打分</a> <button type="submit" onclick="getMarking1()">确定打分</button>-->
