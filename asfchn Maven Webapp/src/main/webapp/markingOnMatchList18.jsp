...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的遥控留空时间滑翔机（P3K-U12） 打分表</h4></div>
    <form action="" >
   ...
   <tr>
    ...
    <c:choose>
    <c:when test="${thisPeopleScore.score181 eq null}">
    第一次留空时间<input type="text" name="min1" >分<input type="text" name="second1" >秒<br>
    第二次留空时间<input type="text" name="min2" >分<input type="text" name="second2" >秒<br>
    第三次留空时间<input type="text" name="min3" >分<input type="text" name="second3" >秒<br>
    
    
    
    </c:when>
    <c:when test="${!(thisPeopleScore.score181 eq null)}">${thisPeopleScore.score181}</c:when>
    </c:choose>
    </td>
    </tr>
    <tr>
   ...
   最后一次飞行<input type="text" name="min4">分<input type="text" name="second4">秒
