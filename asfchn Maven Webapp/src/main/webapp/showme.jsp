...
<body>
 <div class="table-responsive">
	...
	<tr>
	<th>会员名称</th>
	<th><input type="text" name="name" value="${hxPeople.name }"disabled="disabled" >*</th>
	<th> </th>
	<th> </th>
	</tr>
	<tr>
	...
	<th>住址：</th>
	<th><input type="text" name="prop4" value="${hxPeople.prop4 }" disabled="disabled"></th>
	</tr><tr>
	
	
	<th>手机号：</th>
	<th><input type="text" name="prop3" value="${hxPeople.prop3 }" disabled="disabled"></th>
	<th> </th>
	<th> </th>
	</tr><tr>
	...
	<a href="updatePeopleself?id=${hxPeople.id }">更新</a>
