...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的自制水压火箭 50 米打靶赛打分表</h4></div>
    <form action="" >
   ...
   <tr>
    ...
    <input type="text" name="scoreone" style="width:75px" value="${twoptionsmatch.scoreone}">米
    </td>
    </tr>
    <tr>
    <td>第二轮成绩</td>
     <td>
  <input type="text" name="scoretwo" style="width:75px" value="${twoptionsmatch.scoretwo}">米
