...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的遥控弹射滑翔机（P3T） 打分表</h4></div>
    <form action="" >
  ...
  留空时间：<input type="text" name="min1"  style="width:45px">分<input type="text" name="second1"  style="width:75px">秒
 ...
 着陆距离 ：<input type="text" name="twoturnpointmeter" style="width:75px">米<br>
     留空时间： <input type="text" name="min2" style="width:45px">分 <input type="text" name="second2" style="width:75px">秒
