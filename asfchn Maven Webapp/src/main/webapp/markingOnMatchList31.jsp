...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的遥控火箭助推滑翔机（S8D/P） 打分表</h4></div>
    <form action="" >
   ...
   着陆距离  <input type="text" name="oneturnpointmeter"  style="width:75px">厘米（请输入参与计算的数值）<br>
  留空时间 <input type="text" name="min1"  style="width:75px">分<input type="text" name="second1"  style="width:75px">秒
 ...
 着陆距离<input type="text" name="twoturnpointmeter" style="width:75px">厘米（请输入参与计算的数值）<br>
     留空时间 <input type="text" name="min2"  style="width:75px">分<input type="text" name="second2" style="width:75px">秒
