...
<body>
 <div class="table-responsive">
	...
	<tr>
	<!-- <th>出生日期</th>
	<th><input type="text" name="birthday" value="${hxPeople.birthday }" ></th> -->
	<th>会费缴纳时间</th>
	...
	<hr>
	<div align="center" >
	<textarea rows="" cols="" name="personintro">${hxPeople.personintro }</textarea><br>
	<input type="submit" value="修改" onclick="updateHxPeopleInHxTeam()">
	</div>
	</form>
	</div>
	<script type="text/javascript">
	function updateHxPeopleInHxTeam(){
	 var form = document.forms[0];
        form.action = "<%=basePath %>updateHxPeopleInHxTeam";
        form.method = "post";
        form.submit();
