...
<html>
  ...
  <body>
  <div align="center">
  <div><h4>${thisJoinMatchTeamPeople.name }的遥控电动纸飞机（P5Z） 注：本次比赛为穿越龙门赛打分表${rid}</h4></div>
    <form action="" >
...
<input type="text" name="scoreone" style="width:75px" value="${twoptionsmatch.scoreone}">穿越龙门次数
   ...
   <input type="text" name="scoretwo" style="width:75px" value="${twoptionsmatch.scoretwo}">穿越龙门次数
